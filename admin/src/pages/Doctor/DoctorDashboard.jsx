    ...
    return (
      <div className='min-h-screen flex items-center justify-center bg-background dark:bg-zinc-950'>
        <div className='flex flex-col items-center gap-4'>
          ...
          <p className='text-gray-500 dark:text-gray-400 font-medium animate-pulse'>Loading Doctor Dashboard...</p>
        </div>
      </div>
    )
  }
    ...
    <div className='m-5 transition-all duration-300'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 mt-10'>
        ...
        <div className='lg:col-span-2 bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800'>
          <h2 className='text-lg font-bold text-gray-800 dark:text-gray-100 mb-6'>Weekly Booking Activity</h2>
          <div className='h-[300px] w-full'>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={dashData.trends}>
                <defs>
                  <linearGradient id="doctorColor" x1="0" y1="0" x2="0" y2="1">
                ...
                />
                <Area type="monotone" dataKey="count" stroke="#5F6FFF" strokeWidth={3} fillOpacity={1} fill="url(#doctorColor)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
